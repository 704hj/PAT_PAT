...
const LUMI_IMAGE_MAP: Record<string, string> = {
  POSITIVE_high: '/images/icon/lumi/lumi_happy.png', // 괜찮았어요 + 강도 4-5
  POSITIVE_mid: '/images/icon/lumi/lumi_calm.png', // 괜찮았어요 + 강도 3
  POSITIVE_low: '/images/icon/lumi/lumi_serene.png', // 괜찮았어요 + 강도 1-2
  NEGATIVE_high: '/images/icon/lumi/lumi_overwhelmed.png', // 버거웠어요 + 강도 4-5
  NEGATIVE_mid: '/images/icon/lumi/lumi_tired.png', // 버거웠어요 + 강도 3
  NEGATIVE_low: '/images/icon/lumi/lumi_heavy.png', // 버거웠어요 + 강도 1-2
};

function getLumiImage(
  polarity?: string,
...
function ConstellationDeco() {
  ...
  return (
    <svg width="50" height="50" viewBox="0 0 110 65" className="opacity-[0.18]">
      {lines.map(([a, b], i) => (
        <line
          key={i}
          x1={stars[a].x}
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 220,
            background:
              'radial-gradient(ellipse, rgba(80,110,255,0.18) 0%, rgba(40,60,180,0.08) 50%, transparent 75%)',
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse, rgba(80,120,255,0.15), transparent 70%)',
          ...
          >
            ...
            <div
              ...
              style={{
                inset: '-80%',
                background:
                  'conic-gradient(from 0deg, transparent 0deg, transparent 110deg, rgba(100,140,255,0.08) 130deg, rgba(160,200,255,0.6) 165deg, rgba(210,230,255,0.95) 180deg, rgba(160,200,255,0.6) 195deg, rgba(100,140,255,0.08) 220deg, transparent 240deg, transparent 360deg)',
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(155deg, rgba(14,22,58,0.97) 0%, rgba(7,11,32,0.99) 100%)',
              }}
            >
              {/* 상단 빛줄기 */}
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, transparent 0%, rgba(140,170,255,0.5) 40%, rgba(180,200,255,0.7) 55%, rgba(140,170,255,0.5) 70%, transparent 100%)',
                }}
              />

              {/* 우상단 장식 - 감정/강도에 맞는 루미, 없으면 별자리 장식 */}
              {/* <div className="absolute top-13 right-7 pointer-events-none w-[50px] h-[50px] flex items-center justify-center"> */}
              <div className="absolute top-48.5 right-7 pointer-events-none w-[50px] h-[50px] flex items-center justify-center">
                {getLumiImage(
              ...
              <div className="relative px-6 pt-6 pb-5">
                ...
                <div className="flex items-center gap-2 mb-5">
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(90deg, rgba(100,130,255,0.25), transparent)',
                    }}
                  />
                  <svg width="6" height="6" viewBox="0 0 6 6">
                    <polygon
                      points="3,0 3.7,2.3 6,2.3 4.2,3.7 4.9,6 3,4.6 1.1,6 1.8,3.7 0,2.3 2.3,2.3"
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(90deg, transparent, rgba(100,130,255,0.1))',
                    }}
                  />
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(90deg, transparent, rgba(100,130,255,0.12), transparent)',
                  }}
                />
