        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className={['text-[14px] font-bold transition-colors duration-300', allAgreed ? 'text-white' : 'text-white/90'].join(' ')}>
                약관 전체 동의하기
              </span>
              <span className={['text-[11px] transition-colors duration-300', allAgreed ? 'text-sky-300/60' : 'text-white/40'].join(' ')}>
                필수 이용약관 및 개인정보 처리방침
              </span>
            </div>
          </div>
          ...
          <div className="flex gap-3 px-1">
            ...
            >
              ...
              <span className="text-[12px] text-white/60 font-medium">
                개인정보처리방침 <span className="text-sky-300/60 ml-0.5">(필수)</span>
              </span>
              <button
                type="button"
                onClick={(e) => {
